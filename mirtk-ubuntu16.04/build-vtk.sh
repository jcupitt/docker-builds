...
# VTK_RELEASE_VERSION=9.0
# VTK_MICRO_VERSION=1
# the struct pipeline is stuck on vtk8.2 by sphericalmesh
VTK_RELEASE_VERSION=8.2
VTK_MICRO_VERSION=0
...
# we want to build without opengl, so we need to turn a lot of stuff off
echo configure VTK ...
cmake \
